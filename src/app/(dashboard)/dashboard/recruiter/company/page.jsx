...
export default function MyCompaniesPage() {
  ...
  //how would i fetch the data here?? what is the professional way? i tried to use useEffect as you can see. and it's not going to work, i know.

  // useEffect(() => {
  //   const somehting = async () => {
  ...
  useEffect(() => {
    const fetchCompanies = async () => {
      try {
        setIsLoading(true);
        const data = await getCompany(); // Invoke the function
        setCompanyData(data || []);
      } catch (error) {
